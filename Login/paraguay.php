  ...
  <div class="container">
    ...
    <div class="row align-items-center my-5">
        <div class="col-lg-6">
            <div class="row align-items-center my-5">
                <div class="col-lg-3">
                    <img class="imagenBandera img-fluid" src="../img/Paraguay_rounded_200px.webp" alt="">
                </div>
                <div class="col-lg-3">
                    <p><strong class="tituloBandera"><h3>Paraguay</h3></strong></p>
                </div>
            </div>
        </div>
        <div class="col-lg-5">
           <img class="imagenEscudo img-fluid" src="../img/escudo_paraguay.png" alt="">
        </div>
    </div>
    ...
    <div class="row align-items-center my-5">
      <div class="col-lg-7">
        <img class="imagenPrincipal img-fluid" src="../img/paraguay-00.webp" alt="">
      </div>
      <!-- /.col-lg-8 -->
      <div class="col-lg-5">
        <p class="texto">La selección paraguaya es dos veces ganadora de la CONMEBOL Copa América. Levantó el trofeo del torneo en 1953 y 1979. Estos dos títulos, junto con la medalla de plata en los Juegos Olímpicos Atenas 2004, son los mayores logros del combinado guaraní.

        Además, Paraguay alcanzó al menos las semifinales en dos de las últimas tres ediciones de la CONMEBOL Copa América (final en 2011 y semifinales en 2015), a pesar de que ganó solo uno de los 15 partidos disputados en esas ediciones (9 empates y 5 derrotas): fue 1-0, ante Jamaica, en 2015.
