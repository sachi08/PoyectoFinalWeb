	...
	<header class="container">
		...
		<div class="row">
			<div class="col-sm-12 my-4">
				<h1 class="display-3 text-uppercase font-weight-bold text-right mt-5">Registrate</h1>
			</div>
			<div class="col-sm-6">
			...
			<div class="col-sm-6 text-center">
				...
				<form action="">
					...
					<input type="text" class="form-control rounded-0 my-4 text-center" placeholder="Escribe tu Nombre">
					<p class="text-description">Apellido</p>
					<input type="text" class="form-control rounded-0 my-4 text-center" placeholder="Escribe tu Apellido">
					<p class="text-description">Email</p>
					<input type="text" class="form-control rounded-0 my-4 text-center" placeholder="Escribe tu Email">
					<p class="text-description">Usuario</p>
					<input type="text" class="form-control rounded-0 my-4 text-center" placeholder="Escribe tu Usuario">
					...
					<input type="text" class="form-control rounded-0 my-4 text-center" placeholder="Confirma tu contraseña">

					<button class="btn btn-light rounded-0">
						<a href="sigin.php"> ENVIAR </a>
					</button>
				</form>
