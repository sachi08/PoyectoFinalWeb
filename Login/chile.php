  ...
  <div class="container">
    ...
    <div class="row align-items-center my-5">
        <div class="col-lg-6">
            <div class="row align-items-center my-5">
                <div class="col-lg-3">
                    <img class="imagenBandera img-fluid" src="../img/Chile_rounded_200px.webp" alt="">
                </div>
                <div class="col-lg-3">
                    <p><strong class="tituloBandera"><h3>Chile</h3></strong></p>
                </div>
            </div>
        </div>
        <div class="col-lg-5">
           <img class="imagenEscudo img-fluid" src="../img/escudo_chile.png" alt="">
        </div>
    </div>
    ...
    <div class="row align-items-center my-5">
      <div class="col-lg-7">
        <img class="imagenPrincipal img-fluid" src="../img/chile-2019.webp" alt="">
      </div>
      <!-- /.col-lg-8 -->
      <div class="col-lg-5">
        <p class="texto">Conocida como “La Roja”, la selección chilena ha levantado el trofeo en las ediciones (Chile 2015 y Estados Unidos 2016). Estos son sus dos únicos títulos en la competencia.

        Dirigida por el colombiano Reinaldo Rueda, Chile tiene grandes referentes en su equipo nacional, como el defensa y capitán Gary Medel, el volante Arturo Vidal y el delantero Alexis Sánchez, por solo citar algunos.
