  ...
  <div class="container">
    ...
    <div class="row align-items-center my-5">
        <div class="col-lg-6">
            <div class="row align-items-center my-5">
                <div class="col-lg-3">
                    <img class="imagenBandera img-fluid" src="../img/Uruguai_rounded_200px.webp" alt="">
                </div>
                <div class="col-lg-3">
                    <p><strong class="tituloBandera"><h3>Uruguay</h3></strong></p>
                </div>
            </div>
        </div>
        <div class="col-lg-5">
           <img class="imagenEscudo img-fluid" src="../img/escudo_uruguay.png" alt="">
        </div>
    </div>
    ...
    <div class="row align-items-center my-5">
      <div class="col-lg-7">
        <img class="imagenPrincipal img-fluid" src="../img/uruguai-2019.webp" alt="">
      </div>
      <!-- /.col-lg-8 -->
      <div class="col-lg-5">
        <p class="texto">La Selección de Uruguay es la mayor vencedora de la Copa América: con 15 títulos. Fue la Celeste la primera ganadora del torneo, en 1916, y su última consecución del título la logró en el 2011, en el torneo que se disputó en Argentina, venciendo a Paraguay por 3-0.

        Uruguay tan solo ha dejado de participar en una de las 45 ediciones de la Copa América, cuando en 1925 decidió no acudir a la cita en Argentina, por problemas internos dentro de su Asociación.
